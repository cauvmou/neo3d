...
import net.neo3d.deprecated.vulkan.queue.*;
...
import static net.neo3d.deprecated.vulkan.queue.Queue.findQueueFamilies;
...
public class Device {
    ...
    static void createLogicalDevice() {
        ...
        try(MemoryStack stack = stackPush()) {
            ...
            net.neo3d.vulkan.queue.Queue.QueueFamilyIndices indices = findQueueFamilies(physicalDevice);

package net.neo3d.deprecated.vulkan.shader;
...
import net.neo3d.deprecated.vulkan.Device;
import net.neo3d.deprecated.vulkan.Renderer;
import net.neo3d.deprecated.vulkan.Vulkan;
import net.neo3d.deprecated.vulkan.framebuffer.RenderPass;
import net.neo3d.deprecated.vulkan.memory.MemoryManager;
import net.neo3d.deprecated.vulkan.memory.UniformBuffers;
import net.neo3d.deprecated.vulkan.shader.SPIRVUtils.SPIRV;
import net.neo3d.deprecated.vulkan.shader.SPIRVUtils.ShaderKind;
import net.neo3d.deprecated.vulkan.shader.descriptor.Image;
import net.neo3d.deprecated.vulkan.shader.descriptor.ManualUBO;
import net.neo3d.deprecated.vulkan.shader.descriptor.UBO;
import net.neo3d.deprecated.vulkan.shader.layout.AlignedStruct;
import net.neo3d.deprecated.vulkan.shader.layout.PushConstants;
import net.neo3d.deprecated.vulkan.texture.VTextureSelector;
...
import static net.neo3d.deprecated.vulkan.shader.SPIRVUtils.compileShader;
import static net.neo3d.deprecated.vulkan.shader.SPIRVUtils.compileShaderAbsoluteFile;
...
//                uniformBufferPoolSize.type(VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER);
    ...
    public static class Builder {
        ...
        public void compileShaders() {
            String resourcePath = SPIRVUtils.class.getResource("/assets/neo3d/shaders/").toExternalForm();
        ...
        public void parseBindingsJSON() {
            ...
            String resourcePath = String.format("/assets/neo3d/shaders/%s.json", this.shaderPath);

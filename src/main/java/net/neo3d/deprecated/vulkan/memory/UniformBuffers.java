package net.neo3d.deprecated.vulkan.memory;
...
import net.neo3d.deprecated.vulkan.queue.CommandPool;
import net.neo3d.deprecated.vulkan.queue.TransferQueue;
...
import static net.neo3d.deprecated.vulkan.Vulkan.getSwapChainImages;
import static net.neo3d.deprecated.vulkan.util.VUtil.align;

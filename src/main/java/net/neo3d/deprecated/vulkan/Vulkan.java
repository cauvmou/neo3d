...
import net.neo3d.deprecated.vulkan.framebuffer.SwapChain;
import net.neo3d.deprecated.vulkan.memory.Buffer;
import net.neo3d.deprecated.vulkan.memory.MemoryManager;
import net.neo3d.deprecated.vulkan.memory.MemoryTypes;
import net.neo3d.deprecated.vulkan.memory.StagingBuffer;
import net.neo3d.deprecated.vulkan.queue.Queue;
...
import static net.neo3d.deprecated.vulkan.queue.Queue.getQueueFamilies;
import static net.neo3d.deprecated.vulkan.util.VUtil.asPointerBuffer;
...
//            Thread.dumpStack();
    ...
    private static void createInstance() {
        ...
        try(MemoryStack stack = stackPush()) {
            ...
            appInfo.pApplicationName(stack.UTF8Safe("neo3d"));

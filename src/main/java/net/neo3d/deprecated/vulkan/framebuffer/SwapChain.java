package net.neo3d.deprecated.vulkan.framebuffer;

import net.neo3d.deprecated.Initializer;
import net.neo3d.deprecated.render.util.MathUtil;
...
import static net.neo3d.deprecated.vulkan.util.VUtil.UINT32_MAX;

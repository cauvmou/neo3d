package net.neo3d.mixin.vertex;

import com.mojang.blaze3d.vertex.SheetedDecalTextureGenerator;
import com.mojang.blaze3d.vertex.VertexConsumer;
import net.minecraft.core.Direction;
import net.neo3d.interfaces.ExtendedVertexBuilder;
import net.neo3d.render.vertex.VertexUtil;
...
public class VertexMultiConsumersMixin {
    ...
    public static abstract class SheetDecalMixin implements ExtendedVertexBuilder {
